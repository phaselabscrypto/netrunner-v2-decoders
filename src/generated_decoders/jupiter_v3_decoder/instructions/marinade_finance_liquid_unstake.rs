...
#[carbon(discriminator = "0xaa13e8acc6683cc8")]
pub struct MarinadeFinanceLiquidUnstake {
    pub in_amount: Option<u64>,
    pub minimum_out_amount: u64,
    pub platform_fee_bps: u8,
}

pub struct MarinadeFinanceLiquidUnstakeInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for MarinadeFinanceLiquidUnstake {
    type ArrangedAccounts = MarinadeFinanceLiquidUnstakeInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(MarinadeFinanceLiquidUnstakeInstructionAccounts {
