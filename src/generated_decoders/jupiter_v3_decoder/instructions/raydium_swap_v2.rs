...
#[carbon(discriminator = "0x45e3625dedcadf8c")]
...
pub struct RaydiumSwapV2InstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for RaydiumSwapV2 {
    type ArrangedAccounts = RaydiumSwapV2InstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(RaydiumSwapV2InstructionAccounts {
