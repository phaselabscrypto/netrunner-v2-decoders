...
#[carbon(discriminator = "0x0031f60124990b5d")]
...
pub struct LifinityTokenSwapInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for LifinityTokenSwap {
    type ArrangedAccounts = LifinityTokenSwapInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(LifinityTokenSwapInstructionAccounts {
