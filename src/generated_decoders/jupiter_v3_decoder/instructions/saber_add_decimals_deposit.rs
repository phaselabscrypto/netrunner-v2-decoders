...
#[carbon(discriminator = "0x1e825b92805091e8")]
pub struct SaberAddDecimalsDeposit {
    pub in_amount: Option<u64>,
    pub minimum_out_amount: u64,
    pub platform_fee_bps: u8,
}

pub struct SaberAddDecimalsDepositInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for SaberAddDecimalsDeposit {
    type ArrangedAccounts = SaberAddDecimalsDepositInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(SaberAddDecimalsDepositInstructionAccounts {
