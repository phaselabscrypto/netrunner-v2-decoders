...
#[carbon(discriminator = "0xd4e9c9bae2e0318f")]
pub struct MarinadeFinanceDeposit {
    pub in_amount: Option<u64>,
    pub minimum_out_amount: u64,
    pub platform_fee_bps: u8,
}

pub struct MarinadeFinanceDepositInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for MarinadeFinanceDeposit {
    type ArrangedAccounts = MarinadeFinanceDepositInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(MarinadeFinanceDepositInstructionAccounts {
