...
pub mod marinade_finance_deposit;
pub mod marinade_finance_liquid_unstake;
...
pub enum JupiterInstruction {
    ...
    MarinadeFinanceDeposit(marinade_finance_deposit::MarinadeFinanceDeposit),
    MarinadeFinanceLiquidUnstake(marinade_finance_liquid_unstake::MarinadeFinanceLiquidUnstake),
...
impl carbon_core::instruction::InstructionDecoder<'_> for JupiterDecoder {
    ...
    fn decode_instruction(
        ...
        carbon_core::try_decode_instructions!(instruction,
            ...
            JupiterInstruction::MarinadeFinanceDeposit => marinade_finance_deposit::MarinadeFinanceDeposit,
            JupiterInstruction::MarinadeFinanceLiquidUnstake => marinade_finance_liquid_unstake::MarinadeFinanceLiquidUnstake,
