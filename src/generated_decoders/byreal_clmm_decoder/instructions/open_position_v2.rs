...
impl carbon_core::deserialize::ArrangeAccounts for OpenPositionV2 {
    ...
    fn arrange_accounts(
        ...
        let token_account_0 = accounts.get(10)?;
        let token_account_1 = accounts.get(11)?;
        let token_vault_0 = accounts.get(12)?;
        let token_vault_1 = accounts.get(13)?;
        ...
        let token_program_2022 = accounts.get(19)?;
        let vault_0_mint = accounts.get(20)?;
        let vault_1_mint = accounts.get(21)?;
