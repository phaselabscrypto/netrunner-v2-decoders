...
#[carbon(discriminator = "0x1900599c62dcc78c")]
pub struct UnstakeTokenInstant {
    pub params: UnstakeTokenInstantParams,
}

pub struct UnstakeTokenInstantInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for UnstakeTokenInstant {
    type ArrangedAccounts = UnstakeTokenInstantInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(UnstakeTokenInstantInstructionAccounts {
            owner: owner.pubkey,
