...
#[carbon(discriminator = "0x63cf1296ec6cdb93")]
pub struct GetPositionQuote {
    pub params: GetPositionQuoteParams,
}

pub struct GetPositionQuoteInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for GetPositionQuote {
    type ArrangedAccounts = GetPositionQuoteInstructionAccounts;

    fn arrange_accounts(
        accounts: &[solana_sdk::instruction::AccountMeta],
    ) -> Option<Self::ArrangedAccounts> {
        let [perpetuals, pool, market, target_custody, target_oracle_account, collateral_custody, collateral_oracle_account, receiving_custody, receiving_custody_oracle_account, ix_sysvar, _remaining @ ..] =
            accounts
        else {
            return None;
        };

        Some(GetPositionQuoteInstructionAccounts {
