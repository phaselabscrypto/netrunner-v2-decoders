...
#[carbon(discriminator = "0x6b0d8dee98a56057")]
pub struct IncreaseSize {
    pub params: IncreaseSizeParams,
}

pub struct IncreaseSizeInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for IncreaseSize {
    type ArrangedAccounts = IncreaseSizeInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(IncreaseSizeInstructionAccounts {
            owner: owner.pubkey,
