...
#[carbon(discriminator = "0xfd4d647ac2b3362d")]
pub struct ExecuteLimitWithSwap {
    pub params: ExecuteLimitWithSwapParams,
}

pub struct ExecuteLimitWithSwapInstructionAccounts {
    ...
    pub reserve_custody_oracle_account: solana_sdk::pubkey::Pubkey,
...
impl carbon_core::deserialize::ArrangeAccounts for ExecuteLimitWithSwap {
    type ArrangedAccounts = ExecuteLimitWithSwapInstructionAccounts;

    fn arrange_accounts(
        accounts: &[solana_sdk::instruction::AccountMeta],
    ) -> Option<Self::ArrangedAccounts> {
        let [position_owner, fee_payer, transfer_authority, perpetuals, pool, reserve_custody, reserve_custody_oracle_account, position, order, market, target_custody, target_oracle_account, collateral_custody, collateral_oracle_account, collateral_custody_token_account, system_program, collateral_token_program, event_authority, program, ix_sysvar, collateral_mint, _remaining @ ..] =
            accounts
        else {
            return None;
        };

        Some(ExecuteLimitWithSwapInstructionAccounts {
            ...
            reserve_custody_oracle_account: reserve_custody_oracle_account.pubkey,
