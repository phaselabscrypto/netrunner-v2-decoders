...
pub struct SolMip1FulfillBuyInstructionAccounts {
    ...
    pub token_owner_token_record: solana_sdk::pubkey::Pubkey,
    pub pool_token_record: solana_sdk::pubkey::Pubkey,
    pub pool_owner_token_record: solana_sdk::pubkey::Pubkey,
...
impl carbon_core::deserialize::ArrangeAccounts for SolMip1FulfillBuy {
    ...
    fn arrange_accounts(
        ...
        let token_owner_token_record = accounts.get(14)?;
        let pool_token_record = accounts.get(15)?;
        let pool_owner_token_record = accounts.get(16)?;
        ...
        Some(SolMip1FulfillBuyInstructionAccounts {
            ...
            token_owner_token_record: token_owner_token_record.pubkey,
            pool_token_record: pool_token_record.pubkey,
            pool_owner_token_record: pool_owner_token_record.pubkey,
