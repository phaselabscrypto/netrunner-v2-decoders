...
#[carbon(discriminator = "0xaba722c170158e59")]
pub struct SolMplCoreFulfillBuy{
    pub args: SolMplCoreFulfillBuyArgs,
}

pub struct SolMplCoreFulfillBuyInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for SolMplCoreFulfillBuy {
    type ArrangedAccounts = SolMplCoreFulfillBuyInstructionAccounts;
    ...
    fn arrange_accounts(accounts: &[solana_sdk::instruction::AccountMeta]) -> Option<Self::ArrangedAccounts> {
        ...
        Some(SolMplCoreFulfillBuyInstructionAccounts {
            payer: payer.pubkey,
            owner: owner.pubkey,
