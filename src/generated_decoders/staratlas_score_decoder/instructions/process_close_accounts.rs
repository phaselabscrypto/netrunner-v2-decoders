...
impl carbon_core::deserialize::ArrangeAccounts for ProcessCloseAccounts {
    ...
    fn arrange_accounts(
        ...
        let [player_account, ship_staking_account, score_vars_account, ship_token_account_escrow, fuel_token_account_escrow, food_token_account_escrow, arms_token_account_escrow, escrow_authority, token_program, system_program, ship_mint, fuel_mint, food_mint, arms_mint, clock, _remaining @ ..] =
            accounts
        else {
            return None;
        };
