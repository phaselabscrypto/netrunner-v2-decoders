...
#[carbon(discriminator = "0xf9c97e677f78b11d")]
pub struct RaydiumSwapExactOutput {
    pub out_amount: u64,
    pub in_amount_with_slippage: AmountWithSlippage,
    pub platform_fee_bps: u8,
}

pub struct RaydiumSwapExactOutputInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for RaydiumSwapExactOutput {
    type ArrangedAccounts = RaydiumSwapExactOutputInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(RaydiumSwapExactOutputInstructionAccounts {
