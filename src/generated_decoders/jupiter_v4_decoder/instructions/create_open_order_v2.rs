...
#[carbon(discriminator = "0xed215cdedc062acb")]
pub struct CreateOpenOrderV2 {}

pub struct CreateOpenOrderV2InstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for CreateOpenOrderV2 {
    type ArrangedAccounts = CreateOpenOrderV2InstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(CreateOpenOrderV2InstructionAccounts {
