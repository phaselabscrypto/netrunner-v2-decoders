...
#[carbon(discriminator = "0x25b259925bf1ec61")]
pub struct RaydiumClmmSwapExactOutput {
    pub out_amount: u64,
    pub in_amount_with_slippage: AmountWithSlippage,
    pub platform_fee_bps: u8,
}

pub struct RaydiumClmmSwapExactOutputInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for RaydiumClmmSwapExactOutput {
    type ArrangedAccounts = RaydiumClmmSwapExactOutputInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(RaydiumClmmSwapExactOutputInstructionAccounts {
