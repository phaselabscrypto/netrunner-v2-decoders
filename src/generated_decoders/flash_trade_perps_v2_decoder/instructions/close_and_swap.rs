...
#[carbon(discriminator = "0x93a4b9f09b21a57d")]
pub struct CloseAndSwap {
    pub params: CloseAndSwapParams,
}

pub struct CloseAndSwapInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for CloseAndSwap {
    type ArrangedAccounts = CloseAndSwapInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(CloseAndSwapInstructionAccounts {
            owner: owner.pubkey,
