...
#[carbon(discriminator = "0x2c8d1f20f0af11c1")]
pub struct MigrateFlp {
    pub params: MigrateFlpParams,
}

pub struct MigrateFlpInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for MigrateFlp {
    type ArrangedAccounts = MigrateFlpInstructionAccounts;

    fn arrange_accounts(
        accounts: &[solana_sdk::instruction::AccountMeta],
    ) -> Option<Self::ArrangedAccounts> {
        let [owner, compounding_token_account, transfer_authority, perpetuals, pool, flp_stake_account, reward_custody, reward_custody_oracle_account, pool_staked_lp_vault, pool_compounding_lp_vault, lp_token_mint, compounding_token_mint, system_program, token_program, event_authority, program, ix_sysvar, _remaining @ ..] =
            accounts
        else {
            return None;
        };

        Some(MigrateFlpInstructionAccounts {
            owner: owner.pubkey,
