...
#[carbon(discriminator = "0x88ebb505656d3951")]
pub struct WithdrawToken {
    pub params: WithdrawTokenParams,
}

pub struct WithdrawTokenInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for WithdrawToken {
    type ArrangedAccounts = WithdrawTokenInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(WithdrawTokenInstructionAccounts {
            owner: owner.pubkey,
