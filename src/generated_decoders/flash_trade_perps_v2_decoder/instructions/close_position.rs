...
impl carbon_core::deserialize::ArrangeAccounts for ClosePosition {
    ...
    fn arrange_accounts(
        ...
        let [owner, fee_payer, receiving_account, transfer_authority, perpetuals, pool, position, market, target_custody, target_oracle_account, collateral_custody, collateral_oracle_account, collateral_custody_token_account, collateral_token_program, event_authority, program, ix_sysvar, collateral_mint, _remaining @ ..] =
            accounts
        else {
            return None;
        };
