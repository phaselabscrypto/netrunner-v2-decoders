...
#[carbon(discriminator = "0x6ad403fac3e040a0")]
pub struct GetPnl {
    pub params: GetPnlParams,
}

pub struct GetPnlInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for GetPnl {
    type ArrangedAccounts = GetPnlInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(GetPnlInstructionAccounts {
