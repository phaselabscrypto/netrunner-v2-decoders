...
#[carbon(discriminator = "0xc644572bcbab7b52")]
pub struct ExecuteTriggerWithSwap {
    pub params: ExecuteTriggerWithSwapParams,
}

pub struct ExecuteTriggerWithSwapInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for ExecuteTriggerWithSwap {
    type ArrangedAccounts = ExecuteTriggerWithSwapInstructionAccounts;

    fn arrange_accounts(
        accounts: &[solana_sdk::instruction::AccountMeta],
    ) -> Option<Self::ArrangedAccounts> {
        let [position_owner, fee_payer, receiving_account, collateral_account, transfer_authority, perpetuals, pool, position, order, market, target_custody, target_oracle_account, collateral_custody, collateral_oracle_account, collateral_custody_token_account, dispensing_custody, dispensing_oracle_account, dispensing_custody_token_account, event_authority, program, ix_sysvar, receiving_mint, receiving_token_program, collateral_mint, collateral_token_program, _remaining @ ..] =
            accounts
        else {
            return None;
        };

        Some(ExecuteTriggerWithSwapInstructionAccounts {
