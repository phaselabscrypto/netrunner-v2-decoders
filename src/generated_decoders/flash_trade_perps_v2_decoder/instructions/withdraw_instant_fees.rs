...
#[carbon(discriminator = "0xd2ecc17ccd95ffcb")]
pub struct WithdrawInstantFees {
    pub params: WithdrawInstantFeesParams,
}

pub struct WithdrawInstantFeesInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for WithdrawInstantFees {
    type ArrangedAccounts = WithdrawInstantFeesInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(WithdrawInstantFeesInstructionAccounts {
            admin: admin.pubkey,
