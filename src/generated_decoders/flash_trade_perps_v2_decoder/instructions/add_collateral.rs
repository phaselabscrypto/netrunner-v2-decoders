...
pub struct AddCollateral {
    pub params: AddCollateralParams,
}
...
impl carbon_core::deserialize::ArrangeAccounts for AddCollateral {
    ...
    fn arrange_accounts(
        ...
        let [owner, funding_account, perpetuals, pool, position, market, target_custody, target_oracle_account, collateral_custody, collateral_oracle_account, collateral_custody_token_account, funding_token_program, event_authority, program, ix_sysvar, funding_mint, _remaining @ ..] =
            accounts
        else {
            return None;
        };
