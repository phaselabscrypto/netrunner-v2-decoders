...
#[carbon(discriminator = "0x49ae7741950549ef")]
pub struct GetLiquidationPrice {
    pub params: GetLiquidationPriceParams,
}

pub struct GetLiquidationPriceInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for GetLiquidationPrice {
    type ArrangedAccounts = GetLiquidationPriceInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(GetLiquidationPriceInstructionAccounts {
