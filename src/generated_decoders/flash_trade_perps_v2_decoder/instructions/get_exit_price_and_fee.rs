...
#[carbon(discriminator = "0x494d5e1f08095c20")]
pub struct GetExitPriceAndFee {
    pub params: GetExitPriceAndFeeParams,
}

pub struct GetExitPriceAndFeeInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for GetExitPriceAndFee {
    type ArrangedAccounts = GetExitPriceAndFeeInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(GetExitPriceAndFeeInstructionAccounts {
