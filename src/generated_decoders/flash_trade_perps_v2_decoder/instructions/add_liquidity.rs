...
impl carbon_core::deserialize::ArrangeAccounts for AddLiquidity {
    ...
    fn arrange_accounts(
        ...
        let [owner, funding_account, lp_token_account, transfer_authority, perpetuals, pool, custody, custody_oracle_account, custody_token_account, lp_token_mint, token_program, event_authority, program, ix_sysvar, funding_mint, funding_token_program, _remaining @ ..] =
            accounts
        else {
            return None;
        };
