...
#[carbon(discriminator = "0x3f72f6833302f71d")]
...
pub struct SwapTobV3WithReceiverInstructionAccounts {
    ...
    pub sol_receiver: solana_sdk::pubkey::Pubkey,
}

impl carbon_core::deserialize::ArrangeAccounts for SwapTobV3WithReceiver {
    type ArrangedAccounts = SwapTobV3WithReceiverInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        let sol_receiver = accounts.get(14)?;

        Some(SwapTobV3WithReceiverInstructionAccounts {
            payer: payer.pubkey,
            ...
            sol_receiver: sol_receiver.pubkey,
        })
    }
}
