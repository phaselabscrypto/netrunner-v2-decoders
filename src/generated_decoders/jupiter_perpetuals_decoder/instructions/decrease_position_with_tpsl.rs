...
#[carbon(discriminator = "0x6c12cbd1e36741a5")]
...
impl carbon_core::deserialize::ArrangeAccounts for DecreasePositionWithTpsl {
    type ArrangedAccounts = DecreasePositionWithTpslInstructionAccounts;

    fn arrange_accounts(
        accounts: &[solana_sdk::instruction::AccountMeta],
    ) -> Option<Self::ArrangedAccounts> {
        let [keeper, owner, transfer_authority, perpetuals, pool, position_request, position_request_ata, position, custody, custody_doves_price_account, collateral_custody, collateral_custody_doves_price_account, collateral_custody_token_account, token_program, event_authority, program, _remaining @ ..] =
            accounts
        else {
            return None;
        };
