...
#[carbon(discriminator = "0x8b8deec529d3ac13")]
pub struct SwapWithTokenLedger {
    pub params: SwapWithTokenLedgerParams,
}

pub struct SwapWithTokenLedgerInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for SwapWithTokenLedger {
    type ArrangedAccounts = SwapWithTokenLedgerInstructionAccounts;

    fn arrange_accounts(
        accounts: &[solana_sdk::instruction::AccountMeta],
    ) -> Option<Self::ArrangedAccounts> {
        let [owner, funding_account, receiving_account, transfer_authority, perpetuals, pool, receiving_custody, receiving_custody_doves_price_account, receiving_custody_token_account, dispensing_custody, dispensing_custody_doves_price_account, dispensing_custody_token_account, token_ledger, token_program, instruction, event_authority, program, _remaining @ ..] =
            accounts
        else {
            return None;
        };

        Some(SwapWithTokenLedgerInstructionAccounts {
            owner: owner.pubkey,
