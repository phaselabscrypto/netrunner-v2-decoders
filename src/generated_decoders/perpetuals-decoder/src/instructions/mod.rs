...
pub enum PerpetualsInstruction {
    ...
    CreateIncreasePositionMarketRequest(create_increase_position_market_request::CreateIncreasePositionMarketRequest),
    CreateDecreasePositionRequest2(create_decrease_position_request2::CreateDecreasePositionRequest2),
    CreateDecreasePositionMarketRequest(create_decrease_position_market_request::CreateDecreasePositionMarketRequest),
    UpdateDecreasePositionRequest2(update_decrease_position_request2::UpdateDecreasePositionRequest2),
    ...
    IncreasePositionWithInternalSwap(increase_position_with_internal_swap::IncreasePositionWithInternalSwap),
    DecreasePosition4(decrease_position4::DecreasePosition4),
    DecreasePositionWithInternalSwap(decrease_position_with_internal_swap::DecreasePositionWithInternalSwap),
    ...
    GetRemoveLiquidityAmountAndFee2(get_remove_liquidity_amount_and_fee2::GetRemoveLiquidityAmountAndFee2),
...
impl<'a> carbon_core::instruction::InstructionDecoder<'a> for PerpetualsDecoder {
    ...
    fn decode_instruction(
        ...
        carbon_core::try_decode_instructions!(instruction,
            ...
            PerpetualsInstruction::ReallocCustody => realloc_custody::ReallocCustody,
            PerpetualsInstruction::ReallocPool => realloc_pool::ReallocPool,
